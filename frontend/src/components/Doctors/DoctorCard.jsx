...
<div className="mt-[18px] lg:mt-5 flex items-center justify-between">
  ...
  <Link to='/doctor/:id' className='w-[44px] h-[44px] rounded-full border border-solid border-[#1B1A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
